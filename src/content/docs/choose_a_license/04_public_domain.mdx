...
"Written in 2023 by Birgit Blühstreifen and Marcel Moorboden \<m.moorboden\@thuenen.de\>".
```
...
It is also recommended that you include a file called COPYING containing the [CC0 legalcode](https://creativecommons.org/publicdomain/zero/1.0/legalcode.txt) as plain text in root directory of the distribution.

_This recommendation was taken from the [Creative Commons Wiki](https://wiki.creativecommons.org/wiki) which is made available under the [Creative Commons Attribution 4.0 license](https://creativecommons.org/licenses/by/4.0/legalcode)._
