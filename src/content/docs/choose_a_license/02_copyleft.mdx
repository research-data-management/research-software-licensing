...
+ Code under a *Copyleft* license can't easily be incorporated into another software that is licensed under a [permissive license](../03_permissive), in particular if that is a large project with many contributors. If a lot of software in your community is permissively licensed, consider to also use a [permissive license](../03_permissive).
